...
- 2026-05-03: Tightened homepage rendering after live review: Latest Wire now requires strict K-12 relevance and rejects social/link surfaces, top stories prefer preview-ready summaries, stored-rank reads still apply visible-window topic diversity, and headline casing preserves `DPI`.
- 2026-05-03: Fixed Latest Wire false positives caused by synthetic K-12 fallback summaries being reused as relevance evidence; K-12 relevance now ignores those generic generated summaries and wire titles are normalized on display.
